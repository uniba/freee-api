...
module Freee
  module Api
    class Token
      ...
      # @return [Hash] アクセストークン
      def refresh_token(application_id, access_token, refresh_token, expires_at)
        ...
        #}
        @access_token = OAuth2::AccessToken.new(application_id, access_token, refresh_token: refresh_token, expires_at: expires_at)
        begin
